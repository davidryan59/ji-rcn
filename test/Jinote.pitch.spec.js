...
describe('pitch and pitch class API', function() {
  ...
  , ["9/5", "Bb.4", "Bb."]
  , ["15/8", "B'4", "B'"]
  , [{2:999995}, "C(o+999999)", "C"]
  , [{2:999996}, "C(o+ERR)", "C"]
  , [{3:1}, "G5", "G"]
  , [{3:33}, "B####(o+55)", "B####"]
  , [{3:34}, "F(#5)(o+57)", "F(#5)"]
  , [{3:6999998}, "B(#999999)(o+ERR)", "B(#999999)"]
  , [{3:6999999}, "F(#ERR)(o+ERR)", "F(#ERR)"]
  , [{3:-2}, "Bb0", "Bb"]
  , [{3:-29}, "Fbbbb(o-42)", "Fbbbb"]
  , [{3:-30}, "B(b5)(o-44)", "B(b5)"]
  , [{3:-6999994}, "F(b999999)(o-ERR)", "F(b999999)"]
  , [{3:-6999995}, "B(bERR)(o-ERR)", "B(bERR)"]
  , [{5:1}, "E'6", "E'"]
  , [{5:1}, "E'6", "E'", "DR"]
  , [{5:1}, "E'6", "E'", "SAG"]
  , [{5:1}, "E'6", "E'", "DK"]
  ...
  , [{5:4}, "D##''''(o+13)", "D##''''"]
  , [{5:5}, "F###('5)(o+15)", "F###('5)"]
  , [{5:999999}, "C(#571428)('999999)(o+ERR)", "C(#571428)('999999)"]
  , [{5:1000000}, "E(#571428)(5ERR)(o+ERR)", "E(#571428)(5ERR)"]
  , [{5:-1}, "Ab.1", "Ab."]
  , [{5:-4}, "Bbbb....(o-6)", "Bbbb...."]
  , [{5:-5}, "Gbbb(.5)(o-8)", "Gbbb(.5)"]
  , [{5:-999999}, "C(b571428)(.999999)(o-ERR)", "C(b571428)(.999999)"]
  , [{5:-1000000}, "A(b571429)(5ERR)(o-ERR)", "A(b571429)(5ERR)"]
  , ["7/4", "Bb[7]4", "Bb[7]"]
  , ["8/7", "D[1/7]4", "D[1/7]"]
