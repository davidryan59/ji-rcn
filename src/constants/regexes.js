...
var dig2 = consts.MAX_OVERFLOW_DIGITS_2_OCTAVE
var dig3 = consts.MAX_OVERFLOW_DIGITS_3_SHARPS_FLATS
var dig5 = consts.MAX_OVERFLOW_DIGITS_5_SYNTONIC_COMMA
...
module.exports = {
  ...
  REGEX_BRACKETED_OCTAVES_UP: makeRegexForVariableDigits(consts.CHAR_OCTAVE_MARK + consts.CHAR_OCTAVE_UP, dig2),
  REGEX_BRACKETED_OCTAVES_DOWN: makeRegexForVariableDigits(consts.CHAR_OCTAVE_MARK + consts.CHAR_OCTAVE_DOWN, dig2),
  REGEX_BRACKETED_SHARPS: makeRegexForVariableDigits(consts.CHAR_SHARP, dig3),
  REGEX_BRACKETED_FLATS: makeRegexForVariableDigits(consts.CHAR_FLAT, dig3),
  REGEX_BRACKETED_PYTHAG_COMMA_ADD: makeRegexForVariableDigits(consts.CHAR_PYTHAG_ON, dig3),
  REGEX_BRACKETED_PYTHAG_COMMA_REMOVE: makeRegexForVariableDigits(consts.CHAR_PYTHAG_OFF, dig3),
  REGEX_BRACKETED_MERCATOR_COMMA_ADD: makeRegexForVariableDigits(consts.CHAR_MERCATOR_ON, dig3),
  REGEX_BRACKETED_MERCATOR_COMMA_REMOVE: makeRegexForVariableDigits(consts.CHAR_MERCATOR_OFF, dig3),
  REGEX_BRACKETED_SMALL_COMMA_ADD: makeRegexForVariableDigits(consts.CHAR_SMALL_ON, dig3),
  REGEX_BRACKETED_SMALL_COMMA_REMOVE: makeRegexForVariableDigits(consts.CHAR_SMALL_OFF, dig3),
  REGEX_BRACKETED_TINY_COMMA_ADD: makeRegexForVariableDigits(consts.CHAR_TINY_ON, dig3),
  REGEX_BRACKETED_TINY_COMMA_REMOVE: makeRegexForVariableDigits(consts.CHAR_TINY_OFF, dig3),
  REGEX_BRACKETED_SYNTONIC_COMMA_ADD: makeRegexForVariableDigits(consts.CHAR_SYNTONIC_ON, dig5),
  REGEX_BRACKETED_SYNTONIC_COMMA_REMOVE: makeRegexForVariableDigits(consts.CHAR_SYNTONIC_OFF, dig5),
